...
extern void sendchar(unsigned char num) ;  ////20210215sdk
...
******************************************************************************/
xdata const  DOWNLOAD_CMD_S download_cmd[] =  //20210215sdk
{
...
void all_data_update(void)
{
    ...
    mcu_dp_value_update(DPID_TEMP_CURRENT,current_temp); //VALUE型数据上报;
...
static unsigned char dp_download_maxtemp_set_handle(const unsigned char value[], unsigned short length)
{
    //示例:当前DP类型为VALUE
    unsigned char ret;
    xdata unsigned long maxtemp_set;
